...
namespace MainPlugIn
{
  ...
  /// </summary>
  public class MainPlugInPlugIn : Rhino.PlugIns.PlugIn
  {
    public MainPlugInPlugIn()
    {
      Instance = this;
    }

    /// <summary> 
    /// Gets the only instance of the MainPlugInPlugIn plug-in.
    /// </summary>
    public static MainPlugInPlugIn Instance
    {
      get;
      private set;
    }
