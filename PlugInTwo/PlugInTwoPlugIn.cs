...
namespace PlugInTwo
{
  ...
  /// </summary>
  public class PlugInTwoPlugIn : Rhino.PlugIns.PlugIn
  {
    public PlugInTwoPlugIn()
    {
      Instance = this;
    }

    /// <summary>
    /// Gets the only instance of the PlugInTwoPlugIn plug-in.
    /// </summary>
    public static PlugInTwoPlugIn Instance
    {
      get;
      private set;
    }
    ...
    {
      return PlugInTwoCommand.Instance.Integer;
    }
